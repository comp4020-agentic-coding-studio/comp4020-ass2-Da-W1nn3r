...
export const courseMeta = slopCourseMetaSchema.parse({
  ...
  endDate: "2026-11-02",
  description:
    "A production-engineering studio taught entirely inside Factorio: " +
    "throughput analysis, logistics design, and the discipline of building " +
    "systems that don't jam, from the first furnace to an orbiting megabase.",
  tags: ["automation", "logistics", "game-based learning"],
